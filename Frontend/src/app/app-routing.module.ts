...
const routes: Routes = [
  ...
  { path: 'agregar', loadChildren: () => import('./pages/agregar-producto/agregar-producto.module').then(m => m.AgregarProductoPageModule) },
  {
    path: 'agregar/:id',
    loadChildren: () => import('./pages/agregar-producto/agregar-producto.module').then(m => m.AgregarProductoPageModule)
  },
  { path: 'stock', loadChildren: () => import('./pages/cambio-stock/cambio-stock.module').then(m => m.CambioStockPageModule) },
  {
    path: 'stock/:id',
    loadChildren: () => import('./pages/cambio-stock/cambio-stock.module')
